class Robot:
    ...
    def lakukan_aksi(self, lawan):
        print(self.name, " menyerang sebanyak ", self.damage, " DMG")
    ...
    def terima_aksi(self, lawan):
        print(self.name, " menyerang sebanyak ", lawan.damage, " DMG")
...
robot = int(input(f"Pilih robotmu (1 = Antares, 2 = Alphasetia, 3 = Lecalicus): "))
if robot == 1:
    robotmu = Antares()
elif robot == 2:
    robotmu = Alphasetia()
...
robot_lawan = int(input(f"Pilih robot lawan (1 = Antares, 2 = Alphasetia, 3 = Lecalicus): "))
if robot_lawan == 1:
    lawan = Antares()
elif robot_lawan == 2:
    lawan = Alphasetia()
...
print("Selanjutya, pilih 1 untuk batu, 2 untuk kertas, dan 3 untuk gunting")
